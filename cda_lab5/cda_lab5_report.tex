...
\textbf{Question 1)} \underline{Why is hierarchical design important, both when writing HDL code, and when implementing physical circuits? What are the benefits and potential drawbacks?}
...
\textbf{Question 2)} \underline{Explain how a decoder with active high/low outputs can be used to realize any SOP, or multiple SOP functions simultaneously. What are the limitations?}
...
\textbf{Question 3)} \underline{How would you construct an 8-to-1 mux using 4-to-1 muxes?}
