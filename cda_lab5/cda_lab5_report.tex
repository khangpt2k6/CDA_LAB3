...
When $S = 0$, the output follows A regardless of B. When $S = 1$, the output follows B regardless of A. The SOP expression is: $Y = \overline{S} \cdot A + S \cdot B$
...
The design implements a 2-to-1 mux module and uses three instances of it to build the 4-to-1 mux hierarchically. The first two instances handle pairs of inputs using $S_0$ as the select, and the third picks between their outputs using $S_1$. The testbench cycles through all 64 possible combinations of the 6 inputs.

\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{design.png}
\caption{Verilog design module for the 2-to-1 and 4-to-1 multiplexers.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{test_bench.png}
\caption{Testbench code used to verify the 4-to-1 multiplexer across all 64 input combinations.}
\end{figure}

The simulation was run and all 64 test cases passed. A portion of the console output is shown below:

\newpage
\begin{lstlisting}[language={}, basicstyle=\ttfamily\footnotesize]
VCD info: dumpfile wave.vcd opened for output.
 time  S1S0  I3I2I1I0  Q_discrete  Y_ref  EQ  expected  PASS?
-------------------------------------------------------------
   1    00     0000        0         0     1     0       PASS
   2    01     0000        0         0     1     0       PASS
   3    10     0000        0         0     1     0       PASS
   4    11     0000        0         0     1     0       PASS
   5    00     0001        1         1     1     1       PASS
   6    01     0001        0         0     1     0       PASS
   7    10     0001        0         0     1     0       PASS
   8    11     0001        0         0     1     0       PASS
  ...
  61    00     1111        1         1     1     1       PASS
  62    01     1111        1         1     1     1       PASS
  63    10     1111        1         1     1     1       PASS
  64    11     1111        1         1     1     1       PASS
Done.
testbench.sv:49: $finish called at 64 (1s)
\end{lstlisting}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\linewidth]{waveform.png}
\caption{Simulation waveform showing the 4-to-1 multiplexer output across all input combinations.}
\end{figure}
...
\underline{\textbf{Question 1)}} Why is hierarchical design important, both when writing HDL code, and when implementing physical circuits? What are the benefits and potential drawbacks?
...
\underline{\textbf{Question 2)}} Explain how a decoder with active high/low outputs can be used to realize any SOP, or multiple SOP functions simultaneously. What are the limitations?
...
\underline{\textbf{Question 3)}} How would you construct an 8-to-1 mux using 4-to-1 muxes?
